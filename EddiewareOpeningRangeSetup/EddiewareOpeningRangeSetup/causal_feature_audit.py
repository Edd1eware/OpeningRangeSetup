...
ALLOWED_FEATURE_COLUMNS: frozenset[str] = frozenset(
    {
        ...
        "OR_Regime_AtEntry",
        "Vol_Regime_AtEntry",
        # ATAS L2 vs CFD structural-lead laboratory. Every value is frozen at
        # the +3 M1 signal, before the ATAS limit can fill.
        "Pivot_AtEntry",
        "IsLong_AtEntry",
        "HourNY_AtEntry",
        "MinuteNY_AtEntry",
        ...
        # Historical footprint decoded from the completed ATAS signal candle
        # and its already-closed predecessors. No post-entry levels are used.
