    ...
    internal static class SharedTradeSignalSnapshot
    {
        ...
        private static ScoreTradeSignal CloneSignal(ScoreTradeSignal source)
        {
            return new ScoreTradeSignal
            {
                ...
                LiquidityBurstTimestampUtc = source.LiquidityBurstTimestampUtc,
                LiquidityBurstDetectorPublishTimestampUtc = source.LiquidityBurstDetectorPublishTimestampUtc,
                LiquidityBurstEpisodeId = source.LiquidityBurstEpisodeId,
                LiquidityBurstIndexInEpisode = source.LiquidityBurstIndexInEpisode,
                LiquidityBurstSecondsSincePriorBurst = source.LiquidityBurstSecondsSincePriorBurst,
