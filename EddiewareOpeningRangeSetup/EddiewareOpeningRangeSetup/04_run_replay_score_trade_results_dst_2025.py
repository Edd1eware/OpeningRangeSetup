...
# Fechas operables en horario DST de Nueva York 2025.
...
def result_is_terminal(path, min_modified_time=None):
    ...
    if result_label in ("TP", "SL", "EXIT", "BE", "TIME_OVER", "NO_TRADE", "NO_PROFILE", HOLIDAY_NO_DATA_LABEL):
        return True
...
print("\nINICIANDO REPLAY DST 2025 PARA SCORE TRADE RESULTS\n")
failed_dates = []
