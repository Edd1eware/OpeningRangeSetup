...
from telegram_run_summary import clear_telegram_before_run, send_run_summary
...
send_run_summary(RESULTS_FOLDER, DATES_DST, failed_dates, "Temporadas DST completas 2025-2026")

print("\nTERMINO LA PRUEBA DE TEMPORADAS DST COMPLETAS 2025-2026.\n")
